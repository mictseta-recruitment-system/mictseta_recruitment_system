...
class JobPost(models.Model):
    ...
    experience = models.CharField(max_length=6, null=True)
    ...
    application_deadline = models.DateTimeField(null=True)  # Added field for application deadline
...
class Education(models.Model):
    ...
    def __str__(self):
        return f'{self.level} Education for {self.job_post.title} Job Post'
