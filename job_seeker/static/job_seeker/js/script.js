  ...
  function handle_update_computer_skill_button_click() {
        ...
        fetch("https://mictsetarecruitmentsystem-production.up.railway.app/profile/update/computer_skill_information/", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            'X-CSRFToken': getCookie('csrftoken'),
  ...
  function handle_update_soft_skill_button_click() {
        ...
        fetch("https://mictsetarecruitmentsystem-production.up.railway.app/profile/update/soft_skill_information/", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            'X-CSRFToken': getCookie('csrftoken'),
